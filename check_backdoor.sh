...
# 聚焦于已启动的 services
echo; echo "============================================================"
echo ">>> 8. 查看自启动的 service (使用systemctl检查)(按单元文件的修改时间排序，前 20 条):"
echo "============================================================"
...
# SysVinit 检查
echo; echo "============================================================"
echo ">>> 9. 检查 SysVinit 启动相关文件（rc.local、init.d、rcX.d）的修改时间和内容:"
echo "============================================================"
...
echo; echo "============================================================"
echo ">>> 10. /etc/profile.d/ (bash的全局配置文件)目录下的文件的修改时间:"
echo "============================================================"
...
# 列出所有文件
echo; echo "============================================================"
echo ">>> 13. 列出 Systemd 单元文件目录下的所有文件，并按修改时间排序 (前 20 条):"
echo "============================================================"
...
# bash files
echo; echo "============================================================"
echo ">>> 14. bash配置文件检查 (按修改时间从新到旧排序):"
echo "============================================================"
...
echo; echo "============================================================"
echo ">>> 15. 检查 SSH authorized_keys 文件:"
echo "============================================================"
